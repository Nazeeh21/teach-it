...
const WinMacbook = () => (
  <div className="bg-white py-10">
    <div
      style={{
        background: 'linear-gradient(to right, orange, pink , violet , blue)',
        height: 'auto',
      }}
    ...
    >
      <div
        ...
        className="hidden md:block w-full md:w-5/12 lg:w-3/12 lg:mx-16"
      >
        <img
          className="m-auto md:w-10/12 lg:w-11/12 h-auto rounded-lg"
          src="/macbook.png"
          alt="macbook"
        />
      </div>
      ...
      >
        <img
          className="w-8/12 m-auto h-auto rounded-lg"
          src="/macbook.png"
          alt="macbook"
        />
      </div>
