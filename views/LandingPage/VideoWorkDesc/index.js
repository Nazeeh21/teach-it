...
const Index = () => <div className='w-full pl-2 border-2 border-solid border-gray-300 text-darkGrey grid md:grid-flow-rows md:grid-cols-2 md:rid-rows-2 gap-6 pt-6 pb-10 md:pl-10 md:pr-6 xl:pr-0 xl:pl-32'>
