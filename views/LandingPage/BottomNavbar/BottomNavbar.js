...
const BottomNavbar = () => <div className='bg-white py-16'>
  <div className='flex flex-col lg:flex-row justify-center lg:px-10 font-medium '>
    <div className='w-full ml-5 lg:w-3/12 flex flex-col text-lg lg:ml-32'>
      <p className='font-semibold text-2xl lg:mb-8'>Overview</p>
    ...
    <div className='w-full ml-5 lg:w-3/12 flex flex-col text-lg lg:ml-32'>
      <p className='font-semibold mt-8 text-xl lg:mb-8 lg:mt-0'>Legal</p>
      <a className='mt-5' href='/'>Privacy Policy</a>
      <a className='mt-5' href='/'>Terms of use</a>
      <a className='mt-5' href='/'>DMCA</a>
    </div>
    <div className='w-full ml-5 lg:w-6/12 flex flex-col text-lg lg:ml-48 lg:mr-10'>
      <p className='font-semibold mt-8 text-xl lg:mb-8 lg:mt-0'>Updates</p>
      <p className='mt-5'>Sign up for our FREE newsletter and get daily updates on services, offers & promotions.</p>
      <div className='w-full pr-2 lg:pr-0 flex mt-5'>
        <div className='w-8/12 shadow rounded-l-md pt-2 lg:pl-3 pb-2'>
