...
const Unblock = () => (
  <div style={{ color: '#4968FF' }} className="cursor-pointer text-md">
    Unblock
  </div>
)
...
const AcceptedText = () => (
  <div className="text-md text-darkGrey">Accepted on 13/6</div>
)

const PendingText = () => (
  <div style={{ color: '#FF7575' }} className="text-md">
    Pending
  </div>
)
...
const GeneralSetting = () => (
  <div className="w-full">
    ...
    <div className="w-full h-auto mt-5 pt-6 px-5 pb-8 bg-white rounded-lg">
      ...
      <div className="mt-8 w-10/12 md:w-4/12">
