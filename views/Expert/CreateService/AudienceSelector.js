...
const AudienceSelector = ({ activeAgeGroup, ageGroupChangeHandler }) => {
  return (
    <div className="w-full">
      <p className="mt-6 text-lg">Age groups allowed</p>
      <div className="mt-1 mb-2 text-darkGrey text-sm">
        ...
        <div className="grid grid-cols-2 grid-rows-2 grid-flow-row gap-5 my-5">
          <AgeGroupContainer
            ...
            active={activeAgeGroup === AgeGroups[0].value}
            clickHandler={ageGroupChangeHandler}
          />
          <AgeGroupContainer
            ageGroup={AgeGroups[1]}
            active={activeAgeGroup === AgeGroups[1].value}
            clickHandler={ageGroupChangeHandler}
          />
          <AgeGroupContainer
            ageGroup={AgeGroups[2]}
            active={activeAgeGroup === AgeGroups[2].value}
            clickHandler={ageGroupChangeHandler}
          />
        </div>
