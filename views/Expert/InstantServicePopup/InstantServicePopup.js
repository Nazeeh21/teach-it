    ...
    <div className="mx-10 my-6 overflow">
      ...
      <div className="my-5">
        ...
        <div className="rounded-md bg-lightGrey text-darkGrey font-medium text-sm p-4 my-4">
          ...
          offer a one time Live service without too many details. It’s ideal for
          learners who look for immediate consultancy. No restrictions on
