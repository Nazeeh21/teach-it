  ...
  <div className='w-full'>
    ...
    <div className='bg-white rounded-lg p-8'>
      ...
      <div style={{ maxHeight: '70vh'}} className='grid grid-flow-row overflow-y-scroll'>
        <Message type='text' time='4:35pm, 21 June' author={{isSelf: false, profilePic: '/stock/girl2.jpg', name: 'John'}} content='Hi there, how can I help you today?' />
        <Message type='text' time='4:35pm, 21 June' author={{isSelf: false, profilePic: '/stock/girl2.jpg', name: 'John'}} content={<ChooseOption />} />
        <div className='justify-self-end '><Message width='w-full' type='text' time='4:35pm, 21 June' author={{isSelf: true, profilePic: '/stock/girl2.jpg', name: ''}} content='Services' /></div>
        <div className='justify-self-end '><Message width='w-full' type='service' time='4:35pm, 21 June' author={{isSelf: true, profilePic: '/stock/girl2.jpg', name: ''}} 
        content={<CompactServiceCard
