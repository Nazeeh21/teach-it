...
const ChooseService = ({ show = true, clickHandler }) => {
  ...
  const sendOfferCloseHandler = () => (
    setShowSendOffer(false)
  )

  const sendOfferOpenHandler = () => (
    ...
    <div style={{display: !show && 'none'}}>
      ...
      >
        <div className='mx-10 my-6 overflow'>
          <div style={{display: !showSendOffer && 'none' }} className='absolute w-full'>
          ...
          <button className='cursor-pointer text-5xl font-small' onClick={clickHandler}>
            X
          </button>
          <div className='my-5'>
