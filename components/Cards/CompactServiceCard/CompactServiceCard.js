...
const CompactServiceCard = ({ descriptionText }) => <div className='flex flex-row w-full p-2 bg-white shadow-md rounded-lg mb-6'>
  ...
  <div className='p-3 w-10/12 flex flex-col'>
    <p>{loremIpsum.length > 100 ? loremIpsum.substring(1, 50) + '...' : loremIpsum}</p>
