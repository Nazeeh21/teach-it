  ...
  <div className="w-full rounded-lg">
    <div className="h-64 w-full">
      <div
        ...
        className="px-2 flex items-center grid grid-cols-2 grid rows-1 "
      >
        ...
        <div className="items-end flex flex-row justify-self-end items-center">
          <button className="mr-6">
            <img className="w-6 m-auto" src="/setting.png" alt="setting" />
          </button>
          <button className="bg-darkGrey rounded-full w-16 h-16">
            <img className="w-8 m-auto" src="/add-user.png" alt="add-user" />
          </button>
        </div>
      </div>
